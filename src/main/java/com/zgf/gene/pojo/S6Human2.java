...
public class S6Human2 {
    ...
    public String getAnnotaionalle() {
        return annotaionalle;
    }

    public void setAnnotaionalle(String annotaionalle) {
        this.annotaionalle = annotaionalle == null ? null : annotaionalle.trim();
    }
