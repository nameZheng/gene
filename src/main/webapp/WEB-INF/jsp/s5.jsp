			...
			<div id="main" class="row col-sm-12" style="margin-top:20px;margin-bottom:20px;padding-top:15px;padding-bottom:15px;border:1px solid #d7e3dc;">
				<div style="margin-top:20px;margin-bottom:20px;">
					<div class="text-center">					
						<strong>The gene list of the overlapping between carbohydrate/glucose metabolic genes and type 2 diabetes associated genes</strong>
					</div>
					<hr>
				</div>
				<table class="table table-hover" style="table-layout:fixed" >
					<tr>
						...
						<th style="text-align:center;">Xenopus</th>
						<th style="text-align:center;">Zebrafish</th>
					</tr>
					<c:forEach items="${requestScope.s5}" var="gene" varStatus="vs">  
						<tr>
							<td>${gene.getHuman() }</td>
							<td>${gene.getMouse() }</td>
							<td>${gene.getChicken() }</td>
							<td>${gene.getXenopus() }</td>
